...
def node_0_rac_1(input_data: str) -> str:
    ...
    Type: vault_node
    """
    print(f"⚙️ Running: Günlük Tetikle")
    
    prompt = f"""
Role: Cron
Task: Her gün yeni Reel
...
"""
    ...
    print(f"✅ Günlük Tetikle completed")
    return result
...
def node_1_rac_2(input_data: str) -> str:
    ...
    Type: research
    """
    print(f"⚙️ Running: Viral Trend Bul")
    
    prompt = f"""
Role: TikTok Scraper
Task: Viral formatları analiz et
Context: {SYSTEM_CONTEXT}
Input: {input_data}
...
"""
    ...
    result = call_huggingface(prompt)
    print(f"✅ Viral Trend Bul completed")
    return result
...
def node_3_rac_4(input_data: str) -> str:
    ...
    Type: video
    """
    print(f"⚙️ Running: Video Oluştur")
...
"""
    ...
    result = call_huggingface(prompt)
    print(f"✅ Video Oluştur completed")
    return result
...
def node_5_rac_6(input_data: str) -> str:
    ...
    Type: media
    """
    print(f"⚙️ Running: Müzik Ekle")
    
    prompt = f"""
Role: Audio Mix
Task: Trending müzik overlay
Context: {SYSTEM_CONTEXT}
Input: {input_data}
...
def node_6_rac_7(input_data: str) -> str:
    ...
    Type: social
    """
    print(f"⚙️ Running: 🚀 REEL YAYINLA")
    
    prompt = f"""
Role: Instagram API
Task: Reels olarak paylaş
Context: {SYSTEM_CONTEXT}
Input: {input_data}
...
"""
    ...
    result = call_huggingface(prompt)
    print(f"✅ 🚀 REEL YAYINLA completed")
    return result
...
def run_workflow(initial_input: str = "Start"):
    ...
    print("=" * 50)
    print(f"🚀 Starting: Reels Auto Creator")
    ...
    # Send notification
    send_telegram(f"✅ Reels Auto Creator tamamlandı!\n\n{current_output[:500]}...")
    
    return results

if __name__ == "__main__":
    import sys
    initial = sys.argv[1] if len(sys.argv) > 1 else "Workflow başlatıldı"
